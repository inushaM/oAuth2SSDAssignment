package com.ssd.assignment_twows.constant;
...
public class OAuthApplicationSsdConstant {
	...
	public static final String USER_OAUTH_IDENTIFIER_KEY = "MY_TEST_USER";
	public static final String APPLICATION_OAUTH_NAME = "SSD OAuth Spring App";
